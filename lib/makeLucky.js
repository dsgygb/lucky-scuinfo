...
var doNotice = function(start){
    ...
    NoticeModel.findOne({status:true,log:{$ne:"ok"}}).skip(0).limit(1).exec(function(err,doc){
        //console.log(err,doc);
       if(!doc){
           console.log('结束');
           return;
        ...
        request.post(config.noticeApiUrl+"/api/wechat/sendTemplate",{
            ...
            NoticeModel.findByIdAndUpdate(doc._id,{log:"ok",reason:r11.body},function(ee,rr){
